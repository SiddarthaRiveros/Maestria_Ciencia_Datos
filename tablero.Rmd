...
```{r}
paleta6=c("#447270", "#6B9493", "#F6E271", "#F6B916", "#F69312", "#BC6C25", "#002b33")
...
w =dataFc2$timerun/60
hist(w, xlim=c(30,120), ylim=c(0,80),las=1,
  main = " ",
    xlab="Tiempo (min)",
    ylab = "Frecuencia",
    col ="#ee964b")
...
dataMc2=subset(CarreraLuz22, (CarreraLuz22$sex=="Hombre" & CarreraLuz22$categoria=="2. Abierta")) # Dataset de Hombres
x=dataMc2$timerun/60
hist(x, ylim=c(0,250))
h = hist(x)
text(h$mids,h$counts,labels=h$counts, adj=c(0.1, -0.1), vjust = -1)
